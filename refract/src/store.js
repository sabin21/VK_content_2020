...
const state = {
  ...
  stripes: [
    { offset: 0, color: "#000", height: 15, image: "/ph3.jpg", aspect: 0.665 },
    { offset: 6.3, color: "#000", height: 20 , image: "/ph3.jpg", aspect: 0.665}
  ],
  diamonds: [
    { x: 0, offset: 0.15, pos: new Vector3(), scale: 3.5, factor: 2.8 },
